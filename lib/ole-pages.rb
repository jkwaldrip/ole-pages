...
module OlePages
  ...
  Dir['lib/ole_pages/*.rb'].sort.each {|file| require file}
  Dir['lib/ole_pages/base_objects/**/*.rb'].sort.each {|file| require file}
  Dir['lib/ole_pages/page_objects/**/*.rb'].sort.each {|file| require file}
  Dir['lib/ole_pages/data_objects/**/*.rb'].sort.each {|file| require file}
  ...
  class << self
    ...
    def start_browser
      ...
      raise OlePages::Error,"Browser connection not made after 5 minutes." unless browser.is_a?(Watir::Browser)
      browser
    end
